...
const sevas = [
  {
    ...
    duration: "45 Minutes",
    description:
      "A special daily pooja seeking the divine blessings of Sri Raghavendra Swamy.",
  },
  {
    ...
    duration: "30 Minutes",
    description:
      "Traditional Panchamrutha Abhisheka performed with devotion and Vedic rituals.",
  },
  {
    title: "Annadanam",
    image: "/images/Hero.jpg",
    ...
    duration: "Sponsor",
    description:
      "Offer Annadanam and receive the blessings of serving devotees.",
  },
];
